...
discarded by confident rejection without reaching review. The second is
reported in absolute terms as well as as a rate, since a faculty
deciding whether to adopt the pipeline is choosing how many undetected
duplicates to accept in exchange for how much review it avoids, and that
trade is legible in counts and not in percentages.
