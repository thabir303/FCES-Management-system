...
to every pair not confidently rejected. This is reported rather than
avoided: the severity at which the target ceases to be reachable by a
base matcher alone is itself a result, and it bounds what any pipeline of
this shape can offer on records of that quality. The proportion of pairs reaching the language model, and the resulting
